...
Invoke-AtomicTest -TimeoutSeconds 60 test -PathToAtomicsFolder $ScriptDir\atomics
Invoke-AtomicTest -TimeoutSeconds 60 test -PathToAtomicsFolder $ScriptDir\atomics -Cleanup
